// ============================================================
// src/equipmentData.js — HVAC Equipment & Troubleshooting Data Layer
// Full self-contained equipment catalogs, error codes, and diagnostic context
// ============================================================
...
export const heaters = {
  ...
  S8X1B060M4PSC: { hType: UNIT_TYPE.FURNACE, brand: BRAND.TRANE, series: "S8X1", pESP: 0.8, refrigerant: REFRIGERANT.R454B, boardType: BOARD_TYPE.WHITE_RODGERS, imagen: "images/S8*1-2/S8X1B060M4PSC.png", faultCodeRef: "Trane-WhiteRodgers-S8X1", requiresHarness: true, isA2L: true, notes: "Furnace R-454B con sensor de fuga en evap coil y wire harness de seguridad." },
...
export const unidadesExteriores = {
  ...
  // Trane 4TTR (R-410A)
  "4TTR5042": { uType: UNIT_TYPE.CONDENSER, brand: BRAND.TRANE, series: "4TTR", btu: 42000, tons: 3.5, freon: REFRIGERANT.R410A, FactoryCharge: 130, subcooling: 10, isA2L: false },
  "4TTR5048": { uType: UNIT_TYPE.CONDENSER, brand: BRAND.TRANE, series: "4TTR", btu: 48000, tons: 4.0, freon: REFRIGERANT.R410A, FactoryCharge: 114, subcooling: 10, isA2L: false },
  "4TTR5060": { uType: UNIT_TYPE.CONDENSER, brand: BRAND.TRANE, series: "4TTR", btu: 60000, tons: 5.0, freon: REFRIGERANT.R410A, FactoryCharge: 152, subcooling: 10, isA2L: false },
  "4TTR6024": { uType: UNIT_TYPE.CONDENSER, brand: BRAND.TRANE, series: "4TTR", btu: 24000, tons: 2.0, freon: REFRIGERANT.R410A, FactoryCharge: 148, subcooling: 10, isA2L: false },

  // Trane 5TTR50 (R-454B / A2L)
  ...
  // Trane 5TTR60 (R-454B / A2L)
  "5TTR6018": { uType: UNIT_TYPE.CONDENSER, brand: BRAND.TRANE, series: "5TTR6", btu: 18000, tons: 1.5, freon: REFRIGERANT.R454B, FactoryCharge: 60,  subcooling: 10, overCharged: 0,   isA2L: true },
  "5TTR6024": { uType: UNIT_TYPE.CONDENSER, brand: BRAND.TRANE, series: "5TTR6", btu: 24000, tons: 2.0, freon: REFRIGERANT.R454B, FactoryCharge: 58,  subcooling: 10, overCharged: 83,  isA2L: true },
  "5TTR6030": { uType: UNIT_TYPE.CONDENSER, brand: BRAND.TRANE, series: "5TTR6", btu: 30000, tons: 2.5, freon: REFRIGERANT.R454B, FactoryCharge: 56,  subcooling: 10, overCharged: 0,   isA2L: true },
  "5TTR6036": { uType: UNIT_TYPE.CONDENSER, brand: BRAND.TRANE, series: "5TTR6", btu: 36000, tons: 3.0, freon: REFRIGERANT.R454B, FactoryCharge: 56,  subcooling: 10, overCharged: 80,  isA2L: true },
  "5TTR6042": { uType: UNIT_TYPE.CONDENSER, brand: BRAND.TRANE, series: "5TTR6", btu: 42000, tons: 3.5, freon: REFRIGERANT.R454B, FactoryCharge: 81,  subcooling: 10, overCharged: 0,   isA2L: true },
  "5TTR6048": { uType: UNIT_TYPE.CONDENSER, brand: BRAND.TRANE, series: "5TTR6", btu: 48000, tons: 4.0, freon: REFRIGERANT.R454B, FactoryCharge: 106, subcooling: 10, overCharged: 130, isA2L: true },
  "5TTR6060": { uType: UNIT_TYPE.CONDENSER, brand: BRAND.TRANE, series: "5TTR6", btu: 60000, tons: 5.0, freon: REFRIGERANT.R454B, FactoryCharge: 95,  subcooling: 10, overCharged: 119, isA2L: true },
...
// Aliases for troubleshooting engine
export const indoorCatalog = heaters;
export const outdoorCatalog = unidadesExteriores;
...
// ─────────────────────────────────────────────
// BUILD JOB CONTEXT FOR AI / DIAGNOSTICS
// ─────────────────────────────────────────────
export function buildJobContext(state) {
  ...
  const rawSystems = Array.isArray(state.systems) && state.systems.length > 0
    ? state.systems
    : [
        { indoor: state.heaterModel, outdoor: state.outdoorModel },
        ...(state.isTwoSystems ? [{ indoor: state.heaterModel2, outdoor: state.outdoorModel2 }] : [])
      ];

  const systemsContext = rawSystems.map(s => {
    const fData = s.indoor ? getFurnaceModel(s.indoor) : null;
    const cData = s.outdoor ? getCondenserModel(s.outdoor) : null;
    const fRef = fData?.faultCodeRef ? faultCodes[fData.faultCodeRef] : null;
    const ref = cData?.freon || fData?.refrigerant || "Unknown";
    const a2l = cData?.isA2L || fData?.isA2L || false;
    return {
      furnace: fData ? {
        model:          s.indoor,
        brand:          fData.brand,
        ...
        type:           fData.hType,
        pESP:           fData.pESP,
        boardType:      fData.boardType,
        requiresHarness:fData.requiresHarness,
        isA2L:          fData.isA2L || false,
        faultCodes:     fRef?.codes || {},
        notes:          fData.notes || "",
      } : { model: s.indoor, brand: detectBrand(s.indoor) },
      condenser: cData ? {
        model:          s.outdoor,
        brand:          cData.brand,
        series:         cData.series,
        ...
        btu:            cData.btu,
        tons:           cData.tons,
        refrigerant:    cData.freon,
        factoryCharge:  cData.FactoryCharge,
        subcoolingGoal: cData.subcooling,
        overCharged:    cData.overCharged,
        isA2L:          cData.isA2L,
      } : { model: s.outdoor, brand: detectBrand(s.outdoor) },
      refrigerant: ref,
      isA2LSystem: a2l,
    };
  });
  ...
  return {
    ...
    isTwoSystems: rawSystems.length === 2,
    system1:      systemsContext[0] || null,
    system2:      systemsContext[1] || null,
