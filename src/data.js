...
export const ACCESSORY_DISPLAY = {
  [ACCESSORIES.FIN180P]:            { label: "FIN180P",        report: "FIN180P wired and set" },
  [ACCESSORIES.FIN6_MD]:            { label: "FIN6-MD",        report: "FIN6-MD wired" },
  [ACCESSORIES.FLOAT_SWITCH]:       { label: "Float Switch",   report: "Float Switch" },
  [ACCESSORIES.DEHUM]:              { label: "Dehum",          report: "Dehum Box wired" },
  [ACCESSORIES.FA_INTAKE]:          { label: "F/A",            report: "Fresh Air damper wired" },
  [ACCESSORIES.HARMONY]:            { label: "Harmony",        report: "Harmony zone board" },
  [ACCESSORIES.HZ322]:              { label: "HZ322",          report: "HZ322 zone board" },
  [ACCESSORIES.UT3000]:             { label: "UT3000",         report: "UT3000 zone board" },
  [ACCESSORIES.BYPASS]:             { label: "Bypass",         report: "Bypass damper controller" },
  [ACCESSORIES.E_BYPASS]:           { label: "eBypass",        report: "Electronic Bypass Damper wired" },
  [ACCESSORIES.DAPC]:               { label: "DAPC",           report: "DAPC" },
  [ACCESSORIES.APRIL_AIR]:          { label: "AprilAire",      report: "AprilAire" },
  [ACCESSORIES.RDS]:                { label: "RDS",            report: "RDS" },
  [ACCESSORIES.TRANE_HARNESS]:      { label: "Trane Harness",  report: "Trane Harness wired" },
  [ACCESSORIES.ECOIL_WIRE]:         { label: "Ecoil Wire",     report: "Ecoil wire to furnace wired" },
  [ACCESSORIES.LP_KIT_LENNOX_1STG]: { label: "Lennox 1Stg",   report: "Lennox LP Kit 1 Stage" },
  [ACCESSORIES.LP_KIT_LENNOX_2STG]: { label: "Lennox 2Stg",   report: "Lennox LP Kit 2 Stage" },
  [ACCESSORIES.LP_KIT_GOODMAN]:     { label: "Goodman",        report: "Goodman LP Kit" },
  [ACCESSORIES.WEIGHT_IN_DATA]:     { label: "Weigh-In Data",  report: "weigh-in data" },
  [ACCESSORIES.OUT_OF_TOWN]:        { label: "Out of Town",    report: "out of town fee" },
};

export const FIX_DISPLAY = {
  [FIXES.PRESSURE_TEST]:         { label: "Pressure Test", report: "Pressure Test" },
  [FIXES.OPEN_ECOIL]:            { label: "Open Ecoil",    report: "I had to open the ecoil to pull out the sensor wire" },
  [FIXES.WIRES_JAMMED]:          { label: "Jammed Wires",  report: "Compressor wires jammed, fixed them to prevent electrical short" },
  [FIXES.STUCK_BLOWER]:          { label: "Stuck Blower",  report: "Fixed Stuck/Out of balance Blower" },
  [FIXES.CUT_SHEETROCK]:         { label: "Sheetrock",     report: "I had to cut sheetrock to locate tstat wire" },
  [FIXES.EXTENDED_WIRE]:         { label: "Extended Wire", report: "extended wire" },
  [FIXES.EXTENDED_WIRE_FURNACE]: { label: "Furnace",       report: "extended wire to furnace" },
  [FIXES.EXTENDED_WIRE_CUNIT]:   { label: "Cunit",         report: "extended wire to cunit" },
  [FIXES.PVC_WORK]:              { label: "PVC Work",      report: "pvc work" },
  [FIXES.LEAKS_ECOIL]:           { label: "Ecoil",         report: "Fixed Leaks at Ecoil" },
  [FIXES.LEAKS_CUNIT]:           { label: "Cunit",         report: "Fixed Leaks at Cunit" },
  [FIXES.LEAKS_WALL]:            { label: "Inside Wall",   report: "Fixed Leaks Inside the Wall" },
};
